  ...
  return(
    <div className="about">
      <div className="about-one">
        <h2>COMPANY</h2>
        <ul>
          <li> <a href="https://www.swiggy.com/about">About us</a> </li>
          <li> <a href="https://www.swiggy.com/team">Team</a> </li>
          <li> <a href="https://www.swiggy.com/careers">Careers</a> </li>
          <li> <a href="https://blog.swiggy.com/">Swiggy Blog</a> </li>
          <li> <a href="https://www.swiggy.com/bug-bounty">Bug Bounty</a> </li>
          <li> <a href="https://www.swiggy.com/swiggy-super">Swiggy One</a> </li>
          <li> <a href="https://corporate.swiggy.com/">Swiggy Corporate</a> </li>
          <li> <a href="https://www.swiggy.com/swiggy-instamart">Swiggy Instamart</a> </li>
          <li> <a href="https://www.swiggy.com/swiggy-genie">Swiggy Genie</a> </li>
        </ul>
      </div>
      ...
      <div className="about-two">
        ...
        <ul>
          ...
          <li><a href="https://partner-with-us.swiggy.com/onboard#/swiggy">Partner with us</a></li>
          <li><a href="https://ride.swiggy.com/">Ride with us</a></li>
        </ul>
      </div>
      ...
      <div className="about-three">
        <h2>LEGAL</h2>
        <ul>
          <li><a href="https://www.swiggy.com/terms-and-conditions">Terms & Conditions</a></li>
          <li><a href="https://www.swiggy.com/refund-policy">Refund & Cancellation</a></li>
          <li><a href="https://www.swiggy.com/privacy-policy">Privacy Policy</a></li>
          <li><a href="https://www.swiggy.com/cookie-policy">Cookie Policy</a></li>
          <li><a href="https://www.swiggy.com/offer-terms">Offer Terms</a></li>
          <li><a href="https://www.swiggy.com/beware-of-phishing-and-fraud">Phishing & Fraud</a></li>
          <li><a href="https://www.swiggy.com/tnc-corporate-sm">Corporate - Swiggy Money Codes Terms and Conditions</a></li>
          <li><a href="https://www.swiggy.com/tnc-corporate-discount">Corporate - Swiggy Discount Voucher Terms and Conditions</a></li>
        </ul>
      </div>

      <div className="about-four">
        <a href=""><img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_65/icon-AppStore_lg30tv" alt="app-store-icon.png" /></a>
        <a href=""><img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_65/icon-GooglePlay_1_zixjxl" alt="play-store-icon.png" /></a>
      </div>
