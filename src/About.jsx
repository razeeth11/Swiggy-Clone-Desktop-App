    ...
    <div className="about">
      ...
      <div className="about-two">
        ...
        <ul>
          ...
          <li>
            <a href="https://partner-with-us.swiggy.com/onboard#/swiggy">
              Partner with us
            </a>
          </li>
          <li>
      ...
      <div className="about-three">
        ...
        <ul>
          <li>
            <a href="https://www.swiggy.com/terms-and-conditions">
              Terms & Conditions
            </a>
          </li>
          <li>
            <a href="https://www.swiggy.com/refund-policy">
              Refund & Cancellation
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="https://www.swiggy.com/beware-of-phishing-and-fraud">
              Phishing & Fraud
            </a>
          </li>
          <li>
            <a href="https://www.swiggy.com/tnc-corporate-sm">
              Corporate - Swiggy Money Codes Terms and Conditions
            </a>
          </li>
          <li>
            <a href="https://www.swiggy.com/tnc-corporate-discount">
